...
class ApiConfig {
  ...
  // Let's Encrypt certificate. The host now sits on an Elastic IP (100.56.61.121),
  // so this address is stable across instance stop/start. HTTPS keeps iOS App
  // Transport Security happy on physical devices.
  static const String baseUrl = 'https://100-56-61-121.nip.io';
